...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center justify-items-center min-h-screen py-12 gap-8 font-sans">
      <SiteHeader />
      ...
      <main className="w-full max-w-3xl px-4">
        <Suspense fallback={<DashboardSkeleton />}>
          <UsageDashboard key={selectedUser.id} userId={selectedUser.id} />
        </Suspense>
      </main>
    </div>
  );
